...
data "oktapam_gateway_team_passwordless_certificates" "dev-test" {
  name = "dev-test"
}
...
resource "oktapam_connection" "ad-connection" {
  ...
  passwordless_certificate_id = data.oktapam_gateway_team_passwordless_certificates.dev-test.id
