...
func TestAccADCertificateRequest_CSR(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		CheckDestroy:      utils.CreateCheckResourceDestroy(configs.ProviderADCertificateRequestKey, adCertificateExists),
...
func adCertificateExists(id string) (bool, error) {
	client := client.GetLocalClientFromMetadata(testAccProvider.Meta())
