...
func (p SecurityPolicy) ToResourceMap() map[string]interface{} {
	...
	if p.Rules != nil {
		rules := make([]interface{}, len(p.Rules))
...
type SecurityPolicyRuleCondition interface {
	...
	ToResourceMap() map[string]interface{}
}
...
func (c *AccessRequestCondition) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{})
...
func (s *ServerBasedResourceSelector) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{}, 1)

	serversArr := make([]interface{}, 1)
	subSelectorsMap := make(map[string]interface{}, 3)
	serversArr[0] = subSelectorsMap

	individualServersArr := make([]interface{}, 0, len(s.Selectors))
	individualServerAccountsArr := make([]interface{}, 0, len(s.Selectors))
	serverLabelsArr := make([]interface{}, 0, 1)
...
func (s *IndividualServerSubSelector) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{})
...
func (s *IndividualServerAccountSubSelector) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{})
	m[attributes.ServerId] = *s.ServerId.Id
...
func (s *ServerLabelBasedSubSelector) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{})

	serverLabelsM := make(map[string]interface{}, len(s.ServerSelector.Labels))
	for k, v := range s.ServerSelector.Labels {
		serverLabelsM[k] = v
	}
	m[attributes.ServerLabels] = serverLabelsM

	usernamesArr := make([]interface{}, 0)
...
func (c *SecurityPolicyRulePrivilegeContainer) ToResourceMap() map[string]interface{} {
...
func (p *PrincipalAccountRDPPrivilege) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{}, 1)
...
func (p *PrincipalAccountSSHPrivilege) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{}, 1)
	m[attributes.Enabled] = *p.Enabled
	return m
}
...
func (p *PasswordCheckoutRDPPrivilege) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{}, 1)
	m[attributes.Enabled] = *p.Enabled
	return m
}
...
func (p *PasswordCheckoutSSHPrivilege) ToResourceMap() map[string]interface{} {
	m := make(map[string]interface{}, 1)
	m[attributes.Enabled] = *p.Enabled
	return m
}
...
func (r *SecurityPolicyRule) ToResourceMap() map[string]interface{} {
	...
	privileges := make([]interface{}, len(r.Privileges))
	if r.Privileges != nil {
		privilegesM := make(map[string]interface{}, 4)
		passwordCheckoutRDP := make([]interface{}, 0, 1)
		passwordCheckoutSSH := make([]interface{}, 0, 1)
		principalAccountRDP := make([]interface{}, 0, 1)
		principalAccountSSH := make([]interface{}, 0, 1)
	...
	if r.Conditions != nil {
		conditionsM := make(map[string]interface{}, 1)
		accessRequests := make([]interface{}, 0, len(r.Conditions))
