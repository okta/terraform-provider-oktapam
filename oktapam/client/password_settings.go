...
func (s PasswordSettings) ToResourceMap() map[string]interface{} {
	...
	acctsArr := make([]interface{}, len(s.ManagedPrivilegedAccountsConfig))
	...
	if s.CharacterOptions != nil {
		cArr := make([]interface{}, 1)
		cArr[0] = s.CharacterOptions.ToResourceMap()
		m[attributes.CharacterOptions] = cArr
	} else {
		m[attributes.CharacterOptions] = make([]interface{}, 0)
	}

	return m
}

func (o CharacterOptions) ToResourceMap() map[string]interface{} {
