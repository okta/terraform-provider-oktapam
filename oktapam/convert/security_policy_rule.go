...
func SecurityPolicyRuleBlock() schema.Block {
	return schema.SingleNestedBlock{
		Attributes: map[string]schema.Attribute{
			...
			"privileges": schema.SetNestedAttribute{
				NestedObject: SecurityPolicyRulePrivilegeAttributes(),
			},
			"conditions": schema.SetNestedAttribute{
				NestedObject: SecurityPolicyRuleConditionContainerAttributes(),
			},
		...
		Blocks: map[string]schema.Block{
			"privileges": SecurityPolicyPrivilegesBlock(),
			"conditions": SecurityPolicyConditionsBlock(),
		},
	}
}
