...
var (
	...
	ADUserSyncTaskSettingsLDAPQueryFilter = "Specifies the specific criteria used to filter users."
	ADUserSyncTaskSettingsRunTest         = "If `true`, test is performed based on specified AD User Sync Task Settings"
	ADUserSyncTaskSettingsSIDField        = "Name of the AD SID field in User Sync queries"
	ADUserSyncTaskSettingsStartHourUTC    = "If AD user sync task is scheduled to run daily, then specify start hour in UTC"
	ADUserSyncTaskSettingsUPNField        = "Name of the User Principal Name field in User Sync queries"
