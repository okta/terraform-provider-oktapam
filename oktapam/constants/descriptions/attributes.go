...
var (
	...
	ConditionMFA                              = "Configures Multi-Factor Auth settings required to access the resource."
	...
	MFAACRValues                              = "The authentication context class reference value used to defines a specific set of assurance level requirements that the protected resource requires."
	MFAReAuthFrequencyInSeconds               = "The number of seconds a successful MFA is valid for before requiring another MFA to access the resource again."
	...
	SecurityPolicyResouceGroup                = "The ID of the Resource Group to which the Security Policy is constrained.  If this is not set, the Security Policy will apply to all resources for the team.  This value must be set if the user under which the terraform is being applied is a Delegated Security Admin."
