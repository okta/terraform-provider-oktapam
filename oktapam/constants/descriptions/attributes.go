...
var (
	...
	ListElementsUnderPath                     = "Whether to list the Secret/Secret Folder elements that are under this path (true) or to return the element defined by this path (false)."
	...
	ParentFolder                              = "The directory which contains this entity."
