...
var (
	...
	StructuredCommands                        = "A list of commands to allow"
	AddEnv                                    = "A list of environment variables to include when running sudo commands. See [the sudo documentation](https://www.sudo.ws/man/1.8.13/sudoers.man.html#Command_environment)."
	NoExec                                    = "Whether to allow commands to execute child processes"
	SetEnv                                    = "Whether to allow overriding environment variables to commands"
	SubEnv                                    = "A list of environment variables to ignore when running the commands. See [the sudo documentation](https://www.sudo.ws/man/1.8.13/sudoers.man.html#Command_environment)."
	NoPasswd                                  = "Whether to require a password when sudo is run. This should generally not be used as Users don't require a password."
	SudoCommandBundleName                     = "The name of the Sudo Command bundle. This controls the ordering of all bundles within your Team."
	RunAs                                     = "A non-root user account used to run the command"
	...
	DatabaseRole                              = "Roles associated with this database"
	DatabaseRoleAccounts                      = "The list of accounts associated with this database role"
	DatabaseRoleName                          = "The name of the database role"
	DatabaseRoleType                          = "The type of the database role"
	...
	NetworkAddress                            = "The human-readable network address users should use to connect to the database."
	...
	ParentFolderID                            = "The UUID of the directory which contains this Secret/Secret Folder element."
	...
	SecretOrParentFolderPath      = "The path of the Secret or parent Secret Folder"
	...
	SudoDisplayName               = "The name for sudo commands that will be visible to end users"
