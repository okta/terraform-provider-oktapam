...
const (
	...
	CreatedAt = "The UTC time of resource deletion. Format is `year-month-day 00:00:00 +0000 UTC`."
	CreatedByUser = "The ASA User that created the resource."
	DeletedAt = "The UTC time of resource creation. Format is `year-month-day 00:00:00 +0000 UTC`."
	...
	IssuedAt = "The UTC issuance time of the resource. Format is `year-month-day 00:00:00 +0000 UTC`."
	...
	NextUnixGID = "The UID to use when creating a new ASA Server User. Default value starts at 60001."
	NextUnixUID = "The GID to use when creating a new ASA Server User. Default value starts at 63001."
	...
	RemovedAt = "UTC time of resource removal from parent resource. Format is `year-month-day 00:00:00 +0000 UTC`."
