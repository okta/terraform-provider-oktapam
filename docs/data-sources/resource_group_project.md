...
subcategory: ""
description: |-
  Returns an existing PAM Project associated with a specific PAM Resource Group. For details, see Projects https://help.okta.com/en/programs/opa-pam/Content/Topics/privileged-access/pam-projects.htm.
---
