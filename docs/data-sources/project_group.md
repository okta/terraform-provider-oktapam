...
subcategory: ""
description: |-
  Returns a previously created Group assigned to a given Project. For details, see Add a Group to a Project https://help.okta.com/asa/en-us/Content/Topics/Adv_Server_Access/docs/setup/add-a-group-to-project.htm.
---
