...
func (o *Secret) GetTemplate() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *Secret) GetTemplateOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Template) {
...
func (o *Secret) HasTemplate() bool {
	if o != nil && !IsNil(o.Template) {
		return true
	}
...
func (o *Secret) SetTemplate(v map[string]interface{}) *Secret {
	o.Template = v
	return o
}
