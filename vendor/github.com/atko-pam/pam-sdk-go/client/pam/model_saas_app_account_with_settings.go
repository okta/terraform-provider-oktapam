...
func (o *SaasAppAccountWithSettings) GetStatus() PrivilegedAccountStatus {
...
// and a boolean to check if the value has been set.
func (o *SaasAppAccountWithSettings) GetStatusOk() (*PrivilegedAccountStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *SaasAppAccountWithSettings) SetStatus(v PrivilegedAccountStatus) *SaasAppAccountWithSettings {
	o.Status = &v
	return o
}

// GetStatusDetail returns the StatusDetail field value if set, zero value otherwise.
func (o *SaasAppAccountWithSettings) GetStatusDetail() PrivilegedAccountStatusDetail {
...
// and a boolean to check if the value has been set.
func (o *SaasAppAccountWithSettings) GetStatusDetailOk() (*PrivilegedAccountStatusDetail, bool) {
	if o == nil || IsNil(o.StatusDetail) {
		return nil, false
	}
...
func (o *SaasAppAccountWithSettings) SetStatusDetail(v PrivilegedAccountStatusDetail) *SaasAppAccountWithSettings {
	o.StatusDetail = &v
	return o
}

// GetSyncStatus returns the SyncStatus field value if set, zero value otherwise.
func (o *SaasAppAccountWithSettings) GetSyncStatus() PrivilegedAccountSyncStatus {
...
// and a boolean to check if the value has been set.
func (o *SaasAppAccountWithSettings) GetSyncStatusOk() (*PrivilegedAccountSyncStatus, bool) {
	if o == nil || IsNil(o.SyncStatus) {
		return nil, false
	}
...
func (o *SaasAppAccountWithSettings) SetSyncStatus(v PrivilegedAccountSyncStatus) *SaasAppAccountWithSettings {
	o.SyncStatus = &v
	return o
}
