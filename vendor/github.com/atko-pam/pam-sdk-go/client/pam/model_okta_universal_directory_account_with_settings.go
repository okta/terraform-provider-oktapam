...
func (o *OktaUniversalDirectoryAccountWithSettings) GetStatus() PrivilegedAccountStatus {
...
// and a boolean to check if the value has been set.
func (o *OktaUniversalDirectoryAccountWithSettings) GetStatusOk() (*PrivilegedAccountStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *OktaUniversalDirectoryAccountWithSettings) SetStatus(v PrivilegedAccountStatus) *OktaUniversalDirectoryAccountWithSettings {
	o.Status = &v
	return o
}

// GetStatusDetail returns the StatusDetail field value if set, zero value otherwise.
func (o *OktaUniversalDirectoryAccountWithSettings) GetStatusDetail() PrivilegedAccountStatusDetail {
...
// and a boolean to check if the value has been set.
func (o *OktaUniversalDirectoryAccountWithSettings) GetStatusDetailOk() (*PrivilegedAccountStatusDetail, bool) {
	if o == nil || IsNil(o.StatusDetail) {
		return nil, false
	}
...
func (o *OktaUniversalDirectoryAccountWithSettings) SetStatusDetail(v PrivilegedAccountStatusDetail) *OktaUniversalDirectoryAccountWithSettings {
	o.StatusDetail = &v
	return o
}

// GetSyncStatus returns the SyncStatus field value if set, zero value otherwise.
func (o *OktaUniversalDirectoryAccountWithSettings) GetSyncStatus() PrivilegedAccountSyncStatus {
...
// and a boolean to check if the value has been set.
func (o *OktaUniversalDirectoryAccountWithSettings) GetSyncStatusOk() (*PrivilegedAccountSyncStatus, bool) {
	if o == nil || IsNil(o.SyncStatus) {
		return nil, false
	}
...
func (o *OktaUniversalDirectoryAccountWithSettings) SetSyncStatus(v PrivilegedAccountSyncStatus) *OktaUniversalDirectoryAccountWithSettings {
	o.SyncStatus = &v
	return o
}
