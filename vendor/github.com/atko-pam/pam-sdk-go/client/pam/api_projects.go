...
func (r ApiFetchResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsRequest) Execute() (*APIPrivilegedAccountCheckoutSettings, *http.Response, error) {
...
// Execute executes the request
//
//	@return APIPrivilegedAccountCheckoutSettings
func (a *ProjectsAPIService) FetchResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsExecute(r ApiFetchResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsRequest) (*APIPrivilegedAccountCheckoutSettings, *http.Response, error) {
	var (
		traceKey            = "projectsapi.fetchResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettings"
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *APIPrivilegedAccountCheckoutSettings
	)
...
func (r ApiFetchResourceGroupSaasAppBasedProjectCheckoutSettingsRequest) Execute() (*APIPrivilegedAccountCheckoutSettings, *http.Response, error) {
...
//
//	@return APIPrivilegedAccountCheckoutSettings
func (a *ProjectsAPIService) FetchResourceGroupSaasAppBasedProjectCheckoutSettingsExecute(r ApiFetchResourceGroupSaasAppBasedProjectCheckoutSettingsRequest) (*APIPrivilegedAccountCheckoutSettings, *http.Response, error) {
	var (
...
type ApiUpdateResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsRequest struct {
	...
	resourceGroupId                      string
	projectId                            string
	aPIPrivilegedAccountCheckoutSettings *APIPrivilegedAccountCheckoutSettings
}

func (r ApiUpdateResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsRequest) APIPrivilegedAccountCheckoutSettings(aPIPrivilegedAccountCheckoutSettings APIPrivilegedAccountCheckoutSettings) ApiUpdateResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsRequest {
	r.aPIPrivilegedAccountCheckoutSettings = &aPIPrivilegedAccountCheckoutSettings
	return r
}
...
func (a *ProjectsAPIService) UpdateResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsExecute(r ApiUpdateResourceGroupOktaUniversalDirectoryBasedProjectCheckoutSettingsRequest) (*http.Response, error) {
	...
	// body params
	localVarPostBody = r.aPIPrivilegedAccountCheckoutSettings
	localVarHTTPResponse, err := a.client.callAPI(r.ctx, traceKey, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles, nil)
...
func (r ApiUpdateResourceGroupSaasAppBasedProjectCheckoutSettingsRequest) APIPrivilegedAccountCheckoutSettings(aPIPrivilegedAccountCheckoutSettings APIPrivilegedAccountCheckoutSettings) ApiUpdateResourceGroupSaasAppBasedProjectCheckoutSettingsRequest {
	r.aPIPrivilegedAccountCheckoutSettings = &aPIPrivilegedAccountCheckoutSettings
	return r
}
