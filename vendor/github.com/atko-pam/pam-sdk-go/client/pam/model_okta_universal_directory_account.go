...
func (o *OktaUniversalDirectoryAccount) GetStatus() PrivilegedAccountStatus {
...
// and a boolean to check if the value has been set.
func (o *OktaUniversalDirectoryAccount) GetStatusOk() (*PrivilegedAccountStatus, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *OktaUniversalDirectoryAccount) SetStatus(v PrivilegedAccountStatus) *OktaUniversalDirectoryAccount {
	o.Status = &v
	return o
}

// GetStatusDetail returns the StatusDetail field value if set, zero value otherwise.
func (o *OktaUniversalDirectoryAccount) GetStatusDetail() PrivilegedAccountStatusDetail {
...
// and a boolean to check if the value has been set.
func (o *OktaUniversalDirectoryAccount) GetStatusDetailOk() (*PrivilegedAccountStatusDetail, bool) {
	if o == nil || IsNil(o.StatusDetail) {
		return nil, false
	}
...
func (o *OktaUniversalDirectoryAccount) SetStatusDetail(v PrivilegedAccountStatusDetail) *OktaUniversalDirectoryAccount {
	o.StatusDetail = &v
	return o
}

// GetSyncStatus returns the SyncStatus field value if set, zero value otherwise.
func (o *OktaUniversalDirectoryAccount) GetSyncStatus() PrivilegedAccountSyncStatus {
...
// and a boolean to check if the value has been set.
func (o *OktaUniversalDirectoryAccount) GetSyncStatusOk() (*PrivilegedAccountSyncStatus, bool) {
	if o == nil || IsNil(o.SyncStatus) {
		return nil, false
	}
...
func (o *OktaUniversalDirectoryAccount) SetSyncStatus(v PrivilegedAccountSyncStatus) *OktaUniversalDirectoryAccount {
	o.SyncStatus = &v
	return o
}
