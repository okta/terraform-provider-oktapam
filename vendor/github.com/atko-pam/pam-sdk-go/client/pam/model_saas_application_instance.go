...
func NewSaasApplicationInstance(globalAppName string) *SaasApplicationInstance {
...
func (o *SaasApplicationInstance) HasAppInstanceId() bool {
	if o != nil && !IsNil(o.AppInstanceId) {
		return true
	}
...
func (o *SaasApplicationInstance) HasAppInstanceName() bool {
	if o != nil && !IsNil(o.AppInstanceName) {
		return true
	}
